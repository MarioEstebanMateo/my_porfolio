...
export const Navbar = () => {
  return (
    <div className="flex justify-between items-center p-5 shadow-sm">
      <div className="ml-1 hover:scale-110 ease-in-out duration-300">
        <h1 className="font-robotoslab text-primary font-bold text-base sm:text-lg">
          Mario´s Portfolio
        </h1>
      </div>
      <div>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="font-opensans text-primary bg-transparent border border-solid border-primary hover:bg-primary hover:text-white active:bg-primary font-bold uppercase text-xs px-4 py-2 rounded-full outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        >
          Download Resume
        </a>
      </div>
